...
<head>
    ...
    <style>
        ...
        .content {
            padding: 20px;
            margin-left: 0; /* Start content at 0 */
...
<body>
   ...
   <script>
    ...
    function deleteTransaction(transactID) {
        if (confirm("Are you sure you want to delete Transaction ID " + transactID + "?")) {
            // Create an XMLHttpRequest object
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "transaction_function.php", true);
            ...
            xhr.send("transactID=" + transactID);
        }
    }
