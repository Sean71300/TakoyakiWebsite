        ...
        <!--                                             -->
            ...
            <div class="row d-flex flex-row justify-content-evenly mt-5">
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="Octo()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    <p id="price" class="card-title fw-bold w-100" style="display:inline-block"><span class="text-warning" style="display:inline-block">₱</span>39.00</p>
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="Crab()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    <p id="price" class="card-title fw-bold w-100" style="display:inline-block"><span class="text-warning" style="display:inline-block">₱</span>39.00</p>
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="Cheese()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    <p id="price" class="card-title fw-bold w-100" style="display:inline-block"><span class="text-warning" style="display:inline-block">₱</span>39.00</p>
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="Bacon()">+</button>
                </div>
                </div>
            </div>
            ...
            <div class="row d-flex flex-row justify-content-evenly mt-5">
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="specialOcto()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    <p id="price" class="card-title fw-bold w-100" style="display:inline-block"><span class="text-warning" style="display:inline-block">₱</span>100.00</p>
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="specialCrab()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    <p id="price" class="card-title fw-bold w-100" style="display:inline-block"><span class="text-warning" style="display:inline-block">₱</span>100.00</p>
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="specialCheese()">+</button>
                </div>
                </div>
                <div class="card border-0 col" style="width: 15rem">
                <div class="card-body">
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="specialBacon()">+</button>
                </div>
                </div>
            </div>
            ...
            <div class="row mt-5" style="margin-bottom: 150px;">
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="barkadaAssorted()">+</button>
                </div>
                </div>
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <button class="bg-warning border-0 rounded text-white fw-bold" id="scale" style="transition: transform 0.2s ease-in-out; width: 3.5rem; height: 2.75rem; display: inline; margin-top: -18px; margin-right: 20px;" data-bs-toggle="modal" data-bs-target="#input" onclick="barkadaCheesy()">+</button>
                </div>
                </div>
            </div>
